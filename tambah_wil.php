          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="act_wilayah.php">
                    <div class="form-group ">
                      <label for="kabupaten/kota" class="control-label col-lg-2">Kabupaten/Kota <span class="required"></span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="kabupaten/kota" name="kota"  type="text"  required />
                      </div>
                    </div>
                    <div class="form-group ">
                      <label for="desa" class="control-label col-lg-2">kecamatan <span class="required"></span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="kecamatan" name="kecamatan"  type="text"  required />
                      </div>
                    </div>
                    <div class="form-group ">
